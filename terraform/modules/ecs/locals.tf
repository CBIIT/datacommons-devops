locals {
  ...
  task_execution_role_name        = "${var.iam_prefix}-${var.stack_name}-${var.env}-ecs-task-execution-role"
  task_role_name                  = "${var.iam_prefix}-${var.stack_name}-${var.env}-ecs-task-role"
  task_role_policy_exec_name      = "${var.iam_prefix}-${var.stack_name}-${var.env}-ecs-task-role-exec-policy"
