...
| <a name="input_opensearch_autotune_desired_state"></a> [opensearch\_autotune\_desired\_state](#input\_opensearch\_autotune\_desired\_state) | Auto-Tune desired state for the domain - options are 'ENABLED' or 'DISABLED' | `string` | `"ENABLED"` | no |
...
| <a name="input_opensearch_rollback_on_autotune_disable"></a> [opensearch\_rollback\_on\_autotune\_disable](#input\_opensearch\_rollback\_on\_autotune\_disable) | Whether to roll back to default Auto-Tune settings when disabling Auto-Tune - options are 'DEFAULT\_ROLLBACK' or 'NO\_ROLLBACK' | `string` | `"DEFAULT_ROLLBACK"` | no |
