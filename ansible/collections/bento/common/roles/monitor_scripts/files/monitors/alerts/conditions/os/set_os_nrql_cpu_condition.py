...
def setcondition(key, project, tier, policy_id):
   ...
   query = "FROM  Metric SELECT average(`aws.es.CPUUtilization.byCluster`) WHERE collector.name='cloudwatch-metric-streams' AND aws.Namespace='AWS/ES' AND entity.name = '{}-{}-opensearch'"
